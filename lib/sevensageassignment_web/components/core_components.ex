defmodule SevensageassignmentWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(SevensageassignmentWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(SevensageassignmentWeb.Gettext, "errors", msg, opts)
    end
  end
