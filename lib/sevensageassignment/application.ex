defmodule Sevensageassignment.Application do
  ...
  def start(_type, _args) do
    children = [
      SevensageassignmentWeb.Telemetry,
      ...
      SevensageassignmentWeb.Endpoint
    ]

    # See https://hexdocs.pm/elixir/Supervisor.html
    # for other strategies and supported options
    opts = [strategy: :one_for_one, name: Sevensageassignment.Supervisor]
  ...
  def config_change(changed, _new, removed) do
    SevensageassignmentWeb.Endpoint.config_change(changed, removed)
    :ok
  end
